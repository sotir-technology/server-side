...
<!--        <vx-tour :steps="steps" v-if="!disableThemeTour" />-->
        ...
        <vx-sidebar :sidebarItems="sidebarItems" :logo="require('@/assets/images/logo/white/logo_transparent.png')" title="CHURCHA2Z" parent=".layout--main" />
...
<script>
    ...
    import sidebarItems from "@/layouts/churcha2z/components/vx-sidebar/superAdminSideBar.js";
