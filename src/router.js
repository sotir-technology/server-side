...
const router = new Router({
    ...
    routes: [
...

        {
            ...
            path: '',
            name:'churcha2z',
            component: () => import('./layouts/churcha2z/main/superAdminLayout.vue'),
            redirect:'index',
            meta: {
                requiresAuth: true,
                is_superAdmin: true,
            ...
            children: [
                ...
                // =============================================================================
                {
                    path: 'index',
                    name:'index',
                    component: () => import('./views/churcha2z/superAdmin/Index.vue'),
                    meta: {
                ...
                },
                {
                    ...
                    name:'history',
                    component: () => import('./views/churcha2z/superAdmin/profileSettings.vue'),
                    meta: {
                        breadcrumb: [
                            { title: 'Home', url: '/' },
                ...
                {
                    path: 'checkout',
                    component: () => import('./views/churcha2z/superAdmin/Checkout.vue'),
                },
