                    ...
                    <div class="vx-row">
                        ...
                        <div class="vx-col sm:w-full md:w-full lg:w-1/2 mx-auto self-center  d-theme-dark-bg">
                            <div class="p-8">
                                ...
                                <vs-button  type="border" @click="registerUser">Contact Dev</vs-button>
...
export default {
    ...
    methods: {
        login() {
            localStorage.setItem(LOCAL_STORAGE, JSON.stringify({name: 'Onuche', role: 'admin'}));
            this.$router.push(this.$router.currentRoute.query.to || '/')
        },
        contactDeveloperUser() {
