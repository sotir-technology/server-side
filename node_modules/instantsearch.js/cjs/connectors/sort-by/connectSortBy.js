  ...
  return function () {
    ...
    return {
      init: function init(_ref) {
        ...
        var isInitialIndexInItems = (0, _utils.find)(items, function (item) {
        ...
        (0, _utils.warning)(isInitialIndexInItems, "The index named \"".concat(initialIndex, "\" is not listed in the `items` of `sortBy`."));
        renderFn({
